...
class DataCache {
     ...
     */
    public async createItem<Type extends {_id?:string}>(doc:Type):Promise<Type | null> {
        let result = null
     ...
     */
    public async updateItem<Type extends {_id?:string}>(id:string, doc:Type):Promise<Type | null> {
        let result = null
