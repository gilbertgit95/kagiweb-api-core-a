  ...
  up: async (queryInterface, Sequelize) => {
    ...
    */
    await queryInterface.bulkInsert('endpoints', [
      ...
      {
        uuid: 'e1dd4461-3cb6-4a8c-8b18-2b4aa99e4d5b',
        endpoint: '/api/v1/endpoints/:uuid',
        type: 'server',
        category: 'route',
        subcategory: 'PUT',
      ...
      {
        uuid: 'e4401d03-bc3f-4ee2-b344-073b638e0b9c',
        endpoint: '/api/v1/endpoints/:uuid',
        type: 'server',
        category: 'route',
        subcategory: 'GET',
      ...
      {
        uuid: 'c6ff0af1-851c-480c-ba97-69fef72316d2',
        endpoint: '/api/v1/endpoints/:uuid',
        type: 'server',
        category: 'route',
        subcategory: 'DELETE',
      ...
      {
        uuid: '1fc0327c-37a3-45e1-90a4-a9fd1893c6e8',
      ...
      {
        uuid: 'e02d2dfe-eb9e-4928-b601-888ea6d8c52b',
        endpoint: '/api/v1/accounts/:uuid',
        type: 'server',
        category: 'route',
        subcategory: 'GET',
      ...
      {
        uuid: '0d20f262-d07e-4eb7-a8da-6c0d4854b72e',
        endpoint: '/api/v1/accounts/:uuid',
        type: 'server',
        category: 'route',
        subcategory: 'PUT',
      ...
      {
        uuid: 'dd28b232-0b27-471c-9c10-fd63f0d8d05f',
        endpoint: '/api/v1/accounts/:uuid',
        type: 'server',
        category: 'route',
        subcategory: 'DELETE',
      ...
      {
        uuid: 'a1890c7f-bd91-4a87-8aa3-cb21cfc1468e',
      ...
      {
        uuid: '01609e17-5afd-47be-92ff-1565a627baea',
        endpoint: '/api/v1/accounts',
        type: 'server',
        category: 'route',
        subcategory: 'POST',
      ...
      {
        uuid: '9785205b-1e7b-4e3b-bb86-ef0cddda3f53',
        endpoint: '/api/v1/accounts',
        type: 'server',
        category: 'route',
        subcategory: 'PUT',
      ...
      {
        uuid: '526999dc-8998-4c47-9971-1d17f4317997',
      ...
      {
        uuid: '21f92321-dad4-4819-a2dd-45da972008a8',
      ...
      {
        uuid: 'f61f1767-0752-4d37-b5d5-cbe24d81f13c',
        endpoint: '/api/v1/roles/:uuid',
        type: 'server',
        category: 'route',
        subcategory: 'PUT',
      ...
      {
        uuid: '929bd67b-27a4-4095-ada1-8c8326a907de',
        endpoint: '/api/v1/roles/:uuid',
        type: 'server',
        category: 'route',
        subcategory: 'DELETE',
      ...
      {
        uuid: '1572e48d-409f-4fe9-a8ac-cf070419915a',
      ...
      {
        uuid: '74918fc2-3941-4214-a170-dcfb234fa066',
        endpoint: '/api/v1/roles',
        type: 'server',
        category: 'route',
        subcategory: 'GET',
      ...
      {
        uuid: '56f7f65d-3b50-4ddc-8aeb-1e44f2690d73',
        endpoint: '/api/v1/roles',
        type: 'server',
        category: 'route',
        subcategory: 'POST',
      ...
      {
        uuid: '6bf63711-8a5c-4374-900b-23d6dec29b5c',
        endpoint: '/api/v1/roles',
        type: 'server',
        category: 'route',
        subcategory: 'PUT',
      ...
      {
        uuid: 'cbb7d880-2208-4b57-b365-8821d82213d6',
      ...
      {
        uuid: 'a9aba5d6-b765-48b7-9c4c-fd127f3e7717',
        endpoint: '/api/v1/endpoints',
        type: 'server',
        category: 'route',
        subcategory: 'GET',
      ...
      {
        uuid: '274410c8-eab3-4a0f-8801-1d55fa69cbe0',
        endpoint: '/api/v1/endpoints',
        type: 'server',
        category: 'route',
        subcategory: 'POST',
      ...
      {
        uuid: '9801be83-6e88-4096-9349-cb57637fc8ce',
        endpoint: '/api/v1/endpoints',
        type: 'server',
        category: 'route',
        subcategory: 'PUT',
      ...
      {
        uuid: '1fbd3c27-8c8a-49a3-ada7-7a94783cd538',
        endpoint: '/api/v1/accounts',
        type: 'server',
        category: 'route',
        subcategory: 'DELETE',
